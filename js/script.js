        ...
        <article class="post-card ${post.mood}" data-id="${post.id}">
            ...
            <div class="post-footer">
                ...
                <div class="share-actions">
                    ...
                    <div class="share-menu" id="share-menu-${post.id}" data-post-id="${post.id}">
                        ...
                        <button data-share="image" class="share-image-btn">
                        ...
                        <button data-share="native" class="native-share-btn">
...
function handleShareAction(shareType, postId) {
    const text = getPostTextById(postId);
...
function setupEventListeners() {
    ...
    // Handle share menu button clicks via event delegation
    document.addEventListener('click', (e) => {
        const shareBtn = e.target.closest('[data-share]');
        if (shareBtn) {
            const shareMenu = shareBtn.closest('.share-menu');
            const postId = shareMenu?.dataset.postId;
            if (!postId) return;
